                        ...
                        <div className='thirdskillContainer soso'>
                            <p className='thirdheadOfLeftFeild'> <b> Technical Skills </b> </p>
                            {
                                this.state.data[5]?.data?.map((objData, idx) => {
                                    ...
                                    // 1: {new_Skill: 'ES5 | ES6'}
                                    // 2: {new_Skill: 'CSS3'}
                                    return (<div className='thirdskillOfMine'>

                                        <p className='thirdskillOfMine'> <div className='thirdmyNote'></div> {objData.new_Skill}  </p>
                                                ...
                                                feild.data?.map((objData, index) => {
                                                    return (
                                                        <div className='thirdinnerNewItems'>
                                                            <p className='thirdnewName'> <div className='thirdmyNote'></div> <b> {objData.name} </b> </p>

                                                            <div className='thirdnewDesc'>
                                                                {
                                                                    objData.descreption.split("\n").map(desc => {
                                                                        return (
                                                                            <p className='thirdnewDesc'> {desc} </p>)
                                                                    })
                                                                }
                                                            </div>
